...
class DiskAccount(AccountMeta):
        ...
        if containers:
            for cont in containers:
                ...
                if not metadata or not validate_container(metadata):
                    metadata = meta_create_container_metadata(cont_path)
    ...
    def get_container_timestamp(self, container):
        ...
        return int(metadata.get(X_PUT_TIMESTAMP, ('0',0))) or None
